...
# This part of the code sends a prompt to Google's Gemini model to generate MCQs 
# from the extracted PDF text. The response is cleaned, split into questions and answers,
# and returned as two separate lists. This allows the frontend to display the questions 
# and answers in a user-friendly format.
load_dotenv()
